...
//Note: These internalFunctions are used to initialize the various peripherals.
//They are not intended to be called directly (The peripherals are abstracted away by hal__init()
